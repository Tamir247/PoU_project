...
** Food price index-2024 by month
...
** Consumer price index -2024 by month
...
summ cpi if year==2024
scalar base_cpi = r(mean)

summ fcpi if year==2024
...
/*
use $data_out/household_2024.dta, clear
merge m:1 year month using index.dta

gen food_real  = food_exp  / def_fcpi
gen total_real = total_exp / def_cpi
*/
