...
global data2018 "D:\HSES_result_2018\HSES_2018"
global workdata_other "D:\18.FAO\Adept"
...
joinby age_class using "D:\18.FAO\PoU_Training_4-8_NOV_2019\POU data/reference_values", unm(b)
drop _merge 

replace height=int(round(height,1))

joinby gender height using "D:\18.FAO\PoU_Training_4-8_NOV_2019\POU data/sd_value_0to2", unm(b)
drop if _m==2
drop _merge

joinby gender height using "D:\18.FAO\PoU_Training_4-8_NOV_2019\POU data/sd_value_2to5", unm(b)
drop if _m==2
drop _merge
...
joinby itemcode using "D:\18.FAO\Adept\2018\Country_nct_2020_2018_with_Foodout", unm(b)
...
export excel using "$workdata_other/2018/Results_stata_2018_20200421_drop21.csv", sheetreplace firstrow (variables)
